    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <div class="card text-gray-500">
            <div class="card-body">
                ...
                <hr>
                <p class="text-sm mt-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eius molestias fuga iusto debitis praesentium, necessitatibus magni tempora autem aliquam ut architecto consectetur minima voluptatibus non iure, itaque nostrum totam consequuntur? <a class="text-red-500 font-bold" href="">Términos y condiciones</a></p>
            </div>
        </div>
    </div>
