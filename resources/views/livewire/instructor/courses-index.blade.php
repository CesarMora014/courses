<div class="container py-8">
    ...
    <x-table-responsive>
        <div class="px-6 py-4 flex">
            <input wire:model="search" wire:keydown="resetPage" type="text" class="form-input shadow-sm flex-1" placeholder="Ingrese el nombre de un curso">
            
            <a class="btn btn-danger ml-1" href="{{ route('instructor.courses.create')}}">Crear curso</a>
        </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        ...
                                        @else
                                            <img class="h-10 w-10 rounded-full object-cover object-center" src="https://cdn.pixabay.com/photo/2020/05/05/12/12/coffee-5132832_1280.jpg" alt="">
                                        @endisset
                                    </div>
                                    <div class="ml-4">
