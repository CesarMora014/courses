<div>
    <div>
        <h1 class="text-2xl font-bold">Requierimientos del curso</h1>
        <hr class="mt-2 mb-6">
        ...
        <article class="card">
            <div class="card-body bg-gray-100">
                <form wire:submit.prevent="store">
                    <input type="text" class="form-input w-full" wire:model="name" placeholder="Agregue el nombre de un requerimiento">
                    @error('name')
                        <span class="text-xs text-red-500">{{$message}}</span>
                    @enderror
